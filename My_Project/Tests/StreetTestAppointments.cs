...
namespace My_Project.Applications
{
    public partial class StreetTestAppointments : Form
    {
        private int LDLID;
        private int AppID;
        public StreetTestAppointments(int LDLID)
        {
            InitializeComponent();
            this.LDLID = LDLID;
        }
        ...
        {
            dt = clsTestAppointment.GetAlltTestAppointments(this.LDLID, 3);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            if (dt.Rows.Count == 0)
            {
                ...
                ScheduleStreetTest frm = new ScheduleStreetTest(-1, this.LDLID, false);
                frm.ShowDialog();
                LoadData();
                return;
            }
            ...
            {
                ScheduleStreetTest frm = new ScheduleStreetTest(-1, this.LDLID, true);
                 frm.ShowDialog();
                LoadData();
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ScheduleStreetTest frm2 = new ScheduleStreetTest(ID, this.LDLID, appoint1.RetakeTestApplicationID != -1);
        ...
        private void takeTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            TakeStreetTest frm3 = new TakeStreetTest(this.LDLID, ID);
